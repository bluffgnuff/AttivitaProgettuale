...
fn main() {
    ...
    let id = env::args().nth(3).unwrap_or("1-3510223475b1685378947a006b4ec142".to_string());
    let rev = env::args().nth(4).unwrap_or("1-3510223475b1685378947a006b4ec142".to_string());
    let firstname = env::args().nth(5).unwrap_or("Mario".to_string());
    let lastname = env::args().nth(6).unwrap_or("Rossi".to_string());
    let firstname_opt = env::args().nth(7).unwrap_or("Luca".to_string());
    let lastname_opt = env::args().nth(8).unwrap_or("Rossi".to_string());
    ...
    if operation == "Update"{
        customer.insert("_rev".to_string(), rev);
    }
