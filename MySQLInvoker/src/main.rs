...
//  Query execution
    ...
    match req.op{
        Op::Read =>{
// To keep the invoker independent from the data type
...
//	Send back an answer
    ...
    // Uncomment to give command time to show all its output
    // let sleep_duration = time::Duration::from_millis(800);
...
fn main() {
    ...
    // TODO Pass command parameters as env, command args or stdin ?
